...
# iv = Crypto.Random.get_random_bytes(ivSize)
# print('qwe')
...
# origin_image_path =origin_image_file_name + ".jpg"
# encrypt_image_path = f"encrypt_{origin_image_file_name}.png"
# encrypt_image(origin_image_path, encrypt_image_path)
#
# decrypt_image_path = f"decrypt_{origin_image_file_name}.jpg"
...
# origin_audio_path = "dog.wav"
# encrypt_audio_path = f"encrypt_{origin_audio_path}"
# encrypt_audio(origin_audio_path, encrypt_audio_path)
#
# decrypt_audio_path = f"decrypt_{origin_audio_path}"
